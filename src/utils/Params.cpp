...
Params::Params(ros::NodeHandle *const nh) {
  ...
  nh->param<bool>(ns + "/color_failsafe", wayComputer.color_failsafe, true);
  ...
  nh->param<int>(ns + "/min_num_midpts_color_correct", wayComputer.search.min_num_midpts_color_correct, 8);
  nh->param<bool>(ns + "/allow_oneside", wayComputer.search.allow_oneside, false);
  // WayComputer::Way
